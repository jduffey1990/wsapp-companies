...
exports.mapPreviewToProfile = mapPreviewToProfile;
/**
 ...
 */
function mapPreviewToProfile(preview) {
    var _a, _b, _c, _d;
    ...
    const categories = preview.categories || ((_a = preview.enrichment) === null || _a === void 0 ? void 0 : _a.categories) || [];
    ...
    const profile = {
        ...
        coreIdentity: {
            ...
            description: preview.shortDescription || preview.description || ((_b = preview.meta) === null || _b === void 0 ? void 0 : _b.description) || undefined,
            ...
            foundingYear: preview.foundingYear || ((_c = preview.enrichment) === null || _c === void 0 ? void 0 : _c.foundingYear) || undefined,
        },
        // MARKET POSITIONING
        marketPositioning: {
        ...
        // BRAND STYLE
        brandStyle: {
            primaryColor: preview.primaryColor || ((_d = preview.meta) === null || _d === void 0 ? void 0 : _d.themeColor) || undefined,
 ...
 */
function extractSocialLinks(socialLinks) {
    const result = {};
...
function calculateCompletionScore(preview) {
    ...
    const fields = [
        ...
        preview.shortDescription || preview.description || ((_b = preview.meta) === null || _b === void 0 ? void 0 : _b.description),
        preview.headquartersAddress,
        preview.email,
        preview.phone,
        preview.image || preview.favicon,
        preview.industry || (categories.length > 0),
        preview.foundingYear || ((_c = preview.enrichment) === null || _c === void 0 ? void 0 : _c.foundingYear),
        // Social media
        ...
        socialLinks.tiktok,
        // Brand style
        preview.primaryColor || ((_d = preview.meta) === null || _d === void 0 ? void 0 : _d.themeColor),
    ];
